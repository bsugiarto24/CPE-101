...
void test_max_of_three(void){
   ...
   struct cone b = create_cone(2.834,1.34);
   struct cone b2 = create_cone(4.8,4.6);
   struct cone b3 = create_cone(4.8,4.6);
   struct cone max4 = max_of_three(b,b2,b3);
   checkit_double(max4.radius,4.8);
   checkit_double(max4.height,4.6);
